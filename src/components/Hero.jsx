    ...
    >
      <div className="relative z-10 flex flex-col items-center justify-center w-full px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        <div
          ...
          className="flex flex-col gap-3 sm:flex-row sm:gap-4 justify-center items-center w-full mb-10 sm:mb-12"
        >
          <div className="w-full sm:w-auto px-6 py-3 rounded-full border border-brand-saffron/40 bg-gradient-to-r from-brand-saffron/5 to-orange-100/30 text-brand-saffron text-sm sm:text-base tracking-widest uppercase font-bold shadow-sm">
            {t.date}
          </div>
          <div className="w-full sm:w-auto px-6 py-3 rounded-full border border-brand-saffron/40 bg-gradient-to-r from-orange-100/30 to-brand-saffron/5 text-brand-saffron text-sm sm:text-base font-bold tracking-wide shadow-sm">
            {t.location}
          </div>
        </div>
        ...
        <h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-serif font-black text-gray-900 leading-[1.25] tracking-tight mb-6 sm:mb-8 drop-shadow-sm w-full"
        >
          {t.title}
        </h1>
        ...
        {/* Countdown Timer */}
        <div ref={el => elementsRef.current[4] = el} className="w-full mb-12 sm:mb-16">
          <CountdownTimer size="small" />
        </div>

        {/* CTA Button — full width on mobile */}
        <div ref={el => elementsRef.current[5] = el} className="w-full sm:w-auto">
          <button
